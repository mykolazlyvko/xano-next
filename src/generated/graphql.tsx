...
/** Asset system model */
export type AssetCoverImageVideoArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type AssetCreateInput = {
  ...
  coverImageVideo?: InputMaybe<VideoCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  coverImageVideo_every?: InputMaybe<VideoWhereInput>;
  coverImageVideo_none?: InputMaybe<VideoWhereInput>;
  coverImageVideo_some?: InputMaybe<VideoWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type AssetUpdateInput = {
  ...
  coverImageVideo?: InputMaybe<VideoUpdateManyInlineInput>;
...
export type Author = Entity & Node & {
  __typename?: 'Author';
  attribute: Array<PersonCat>;
  /** Add a profile avatar for authors */
  avatar?: Maybe<Asset>;
...
export type AuthorCreateInput = {
  attribute?: InputMaybe<Array<PersonCat>>;
...
export type AuthorManyWhereInput = {
  ...
  attribute_contains_all?: InputMaybe<Array<PersonCat>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  attribute_contains_none?: InputMaybe<Array<PersonCat>>;
  /** Matches if the field array contains at least one item provided to the filter */
  attribute_contains_some?: InputMaybe<Array<PersonCat>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  attribute_not?: InputMaybe<Array<PersonCat>>;
...
export type Feeling = Entity & Node & {
  __typename?: 'Feeling';
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<Feeling>;
  /** List of Feeling versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID']['output'];
  /** The time the document was published. Null on documents in draft stage. */
...
export type FeelingCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type FeelingDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean']['input'];
  inheritLocale?: Scalars['Boolean']['input'];
  stages?: Array<Stage>;
};
...
export type FeelingHistoryArgs = {
  limit?: Scalars['Int']['input'];
  skip?: Scalars['Int']['input'];
  stageOverride?: InputMaybe<Stage>;
};
...
export type FeelingPublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type FeelingScheduledInArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type FeelingUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type FeelingConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
...
/** A connection to a list of items. */
export type FeelingConnection = {
  __typename?: 'FeelingConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<FeelingEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type FeelingCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};

export type FeelingCreateManyInlineInput = {
  /** Connect multiple existing Feeling documents */
  connect?: InputMaybe<Array<FeelingWhereUniqueInput>>;
  /** Create and connect multiple existing Feeling documents */
  create?: InputMaybe<Array<FeelingCreateInput>>;
};

export type FeelingCreateOneInlineInput = {
  /** Connect one existing Feeling document */
  connect?: InputMaybe<FeelingWhereUniqueInput>;
  /** Create and connect one Feeling document */
  create?: InputMaybe<FeelingCreateInput>;
};

/** An edge in a connection. */
export type FeelingEdge = {
  __typename?: 'FeelingEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: Feeling;
...
/** Identifies documents */
export type FeelingManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FeelingWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FeelingWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<FeelingWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']['input']>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  documentInStages_every?: InputMaybe<FeelingWhereStageInput>;
  documentInStages_none?: InputMaybe<FeelingWhereStageInput>;
  documentInStages_some?: InputMaybe<FeelingWhereStageInput>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export enum FeelingOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
export type FeelingUpdateInput = {
  title?: InputMaybe<Scalars['String']['input']>;
};

export type FeelingUpdateManyInlineInput = {
  /** Connect multiple existing Feeling documents */
  connect?: InputMaybe<Array<FeelingConnectInput>>;
  /** Create and connect multiple Feeling documents */
  create?: InputMaybe<Array<FeelingCreateInput>>;
  /** Delete multiple Feeling documents */
  delete?: InputMaybe<Array<FeelingWhereUniqueInput>>;
  /** Disconnect multiple Feeling documents */
  disconnect?: InputMaybe<Array<FeelingWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Feeling documents */
  set?: InputMaybe<Array<FeelingWhereUniqueInput>>;
  /** Update multiple Feeling documents */
  update?: InputMaybe<Array<FeelingUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Feeling documents */
  upsert?: InputMaybe<Array<FeelingUpsertWithNestedWhereUniqueInput>>;
};

export type FeelingUpdateManyInput = {
  title?: InputMaybe<Scalars['String']['input']>;
};

export type FeelingUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: FeelingUpdateManyInput;
  /** Document search */
  where: FeelingWhereInput;
};

export type FeelingUpdateOneInlineInput = {
  /** Connect existing Feeling document */
  connect?: InputMaybe<FeelingWhereUniqueInput>;
  /** Create and connect one Feeling document */
  create?: InputMaybe<FeelingCreateInput>;
  /** Delete currently connected Feeling document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected Feeling document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single Feeling document */
  update?: InputMaybe<FeelingUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Feeling document */
  upsert?: InputMaybe<FeelingUpsertWithNestedWhereUniqueInput>;
};

export type FeelingUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: FeelingUpdateInput;
  /** Unique document search */
  where: FeelingWhereUniqueInput;
};

export type FeelingUpsertInput = {
  /** Create document if it didn't exist */
...
export type FeelingUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: FeelingUpsertInput;
  /** Unique document search */
  where: FeelingWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type FeelingWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Identifies documents */
export type FeelingWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FeelingWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FeelingWhereInput>>;
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type FeelingWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<FeelingWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<FeelingWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<FeelingWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<FeelingWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};

/** References Feeling record uniquely */
export type FeelingWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']['input']>;
};
...
export type Mutation = {
  ...
  /** Delete one feeling from _all_ existing stages. Returns deleted document. */
  deleteFeeling?: Maybe<Feeling>;
  /**
  ...
  /**
   * Delete many Feeling documents
   * @deprecated Please use the new paginated many mutation (deleteManyFeelingsConnection)
   */
  deleteManyFeelings: BatchPayload;
  /** Delete many Feeling documents, return deleted documents */
  deleteManyFeelingsConnection: FeelingConnection;
  /**
  ...
  /**
   * Publish many Feeling documents
   * @deprecated Please use the new paginated many mutation (publishManyFeelingsConnection)
   */
  publishManyFeelings: BatchPayload;
  /** Publish many Feeling documents */
  publishManyFeelingsConnection: FeelingConnection;
  /**
  ...
  /** Schedule to publish one feeling */
  schedulePublishFeeling?: Maybe<Feeling>;
  ...
  /** Unpublish one feeling from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishFeeling?: Maybe<Feeling>;
  ...
  /** Unpublish one feeling from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishFeeling?: Maybe<Feeling>;
  /**
  ...
  /**
   * Unpublish many Feeling documents
   * @deprecated Please use the new paginated many mutation (unpublishManyFeelingsConnection)
   */
  unpublishManyFeelings: BatchPayload;
  /** Find many Feeling documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyFeelingsConnection: FeelingConnection;
  /**
  ...
  /**
   * Update many feelings
   * @deprecated Please use the new paginated many mutation (updateManyFeelingsConnection)
   */
  updateManyFeelings: BatchPayload;
  /** Update many Feeling documents */
  updateManyFeelingsConnection: FeelingConnection;
  /**
...
export type MutationDeleteFeelingArgs = {
  where: FeelingWhereUniqueInput;
};
...
export type MutationDeleteManyFeelingsArgs = {
  where?: InputMaybe<FeelingManyWhereInput>;
};


export type MutationDeleteManyFeelingsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationPublishFeelingArgs = {
  to?: Array<Stage>;
  where: FeelingWhereUniqueInput;
};
...
export type MutationPublishManyFeelingsArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<FeelingManyWhereInput>;
};


export type MutationPublishManyFeelingsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishFeelingArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  to?: Array<Stage>;
  where: FeelingWhereUniqueInput;
...
export type MutationScheduleUnpublishFeelingArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  where: FeelingWhereUniqueInput;
...
export type MutationUnpublishFeelingArgs = {
  from?: Array<Stage>;
  where: FeelingWhereUniqueInput;
};
...
export type MutationUnpublishManyFeelingsArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<FeelingManyWhereInput>;
};


export type MutationUnpublishManyFeelingsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: Array<Stage>;
...
export type MutationUpdateManyFeelingsArgs = {
  data: FeelingUpdateManyInput;
  where?: InputMaybe<FeelingManyWhereInput>;
};


export type MutationUpdateManyFeelingsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  data: FeelingUpdateManyInput;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationUpsertFeelingArgs = {
  upsert: FeelingUpsertInput;
  where: FeelingWhereUniqueInput;
};
...
export type PostCreateInput = {
  attribute?: InputMaybe<Array<PostCat>>;
...
export type PostManyWhereInput = {
  ...
  attribute?: InputMaybe<Array<PostCat>>;
  /** Matches if the field array contains *all* items provided to the filter */
  attribute_contains_all?: InputMaybe<Array<PostCat>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  attribute_contains_none?: InputMaybe<Array<PostCat>>;
  /** Matches if the field array contains at least one item provided to the filter */
  attribute_contains_some?: InputMaybe<Array<PostCat>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  attribute_not?: InputMaybe<Array<PostCat>>;
  author?: InputMaybe<AuthorWhereInput>;
...
export type Query = {
  ...
  /** Retrieve a single feeling */
  feeling?: Maybe<Feeling>;
  /** Retrieve document version */
  feelingVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple feelings */
  feelings: Array<Feeling>;
  /** Retrieve multiple feelings using the Relay connection interface */
  feelingsConnection: FeelingConnection;
...
export type QueryFeelingVersionArgs = {
  where: VersionWhereInput;
};


export type QueryFeelingsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  locales?: Array<Locale>;
  orderBy?: InputMaybe<FeelingOrderByInput>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  stage?: Stage;
  where?: InputMaybe<FeelingWhereInput>;
};


export type QueryFeelingsConnectionArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type ScheduledOperationAffectedDocument = Asset | Author | Comment | Feeling | Navigation | Page | Post | Video;
...
export type SeoOverrideParent = Page | Post | Video;
...
export type VideoCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
  seo?: InputMaybe<SeoOverrideCreateOneInlineInput>;
  title?: InputMaybe<Scalars['String']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type VideoManyWhereInput = {
  ...
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  seo?: InputMaybe<SeoOverrideWhereInput>;
  title?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  title_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
...
export type VideoUpdateInput = {
  ...
  coverImage?: InputMaybe<AssetUpdateOneInlineInput>;
  description?: InputMaybe<Scalars['String']['input']>;
  seo?: InputMaybe<SeoOverrideUpdateOneInlineInput>;
  title?: InputMaybe<Scalars['String']['input']>;
};
...
export type AuthorQuery = { __typename?: 'Query', author: { __typename?: 'AuthorConnection', edges: Array<{ __typename?: 'AuthorEdge', node: { __typename?: 'Author', name: string, title?: string | null, biography?: string | null, avatar?: { __typename?: 'Asset', url: string } | null } }> } };

export type FeelingQueryVariables = Exact<{ [key: string]: never; }>;


export type FeelingQuery = { __typename?: 'Query', feelings: Array<{ __typename?: 'Feeling', id: string, title?: string | null }> };
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', title: string, content: { __typename?: 'PostContentRichText', html: string }, coverImage?: { __typename?: 'Asset', url: string } | null, author?: { __typename?: 'Author', name: string, title?: string | null, avatar?: { __typename?: 'Asset', url: string } | null } | null } | null };

export type PostsByTypeQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<PostOrderByInput>;
  attribute?: InputMaybe<Array<PostCat> | PostCat>;
}>;


export type PostsByTypeQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', slug: string, title: string, coverImage?: { __typename?: 'Asset', url: string } | null }> };

export type TopAnxietyQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<AuthorOrderByInput>;
}>;


export type TopAnxietyQuery = { __typename?: 'Query', author: { __typename?: 'AuthorConnection', edges: Array<{ __typename?: 'AuthorEdge', node: { __typename?: 'Author', name: string, title?: string | null, avatar?: { __typename?: 'Asset', url: string } | null } }> } };

export type TopDepressionQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<AuthorOrderByInput>;
}>;


export type TopDepressionQuery = { __typename?: 'Query', author: { __typename?: 'AuthorConnection', edges: Array<{ __typename?: 'AuthorEdge', node: { __typename?: 'Author', name: string, title?: string | null, avatar?: { __typename?: 'Asset', url: string } | null } }> } };

export type VideosByTypeQueryVariables = Exact<{
  length?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<VideoOrderByInput>;
  attribute?: InputMaybe<Array<PostCat> | PostCat>;
}>;
...
export type VideosByTypeQuery = { __typename?: 'Query', videos: Array<{ __typename?: 'Video', title?: string | null, description?: string | null, coverImage?: { __typename?: 'Asset', url: string } | null }> };


export const AuthorDocument = gql`
    query Author($length: Int = 6, $orderBy: AuthorOrderByInput = createdAt_ASC) {
  author: authorsConnection(first: $length, orderBy: $orderBy) {
    edges {
      node {
        name
        avatar {
...
export function useFeelingQuery(options?: Omit<Urql.UseQueryArgs<FeelingQueryVariables>, 'query'>) {
  return Urql.useQuery<FeelingQuery, FeelingQueryVariables>({ query: FeelingDocument, ...options });
};
...
export const PostsByTypeDocument = gql`
    query PostsByType($length: Int = 6, $orderBy: PostOrderByInput = createdAt_DESC, $attribute: [PostCat!] = [education]) {
  posts(
    first: $length
    orderBy: $orderBy
    where: {attribute_contains_some: $attribute}
  ) {
    slug
    coverImage {
      url
...
export function usePostsByTypeQuery(options?: Omit<Urql.UseQueryArgs<PostsByTypeQueryVariables>, 'query'>) {
  return Urql.useQuery<PostsByTypeQuery, PostsByTypeQueryVariables>({ query: PostsByTypeDocument, ...options });
};
export const TopAnxietyDocument = gql`
...
export function useTopAnxietyQuery(options?: Omit<Urql.UseQueryArgs<TopAnxietyQueryVariables>, 'query'>) {
  return Urql.useQuery<TopAnxietyQuery, TopAnxietyQueryVariables>({ query: TopAnxietyDocument, ...options });
};
export const TopDepressionDocument = gql`
    query TopDepression($length: Int = 6, $orderBy: AuthorOrderByInput = createdAt_DESC) {
  author: authorsConnection(
    first: $length
    orderBy: $orderBy
    where: {attribute_contains_some: depression}
  ) {
    edges {
      node {
        name
...
export function useTopDepressionQuery(options?: Omit<Urql.UseQueryArgs<TopDepressionQueryVariables>, 'query'>) {
  return Urql.useQuery<TopDepressionQuery, TopDepressionQueryVariables>({ query: TopDepressionDocument, ...options });
};
export const VideosByTypeDocument = gql`
    query VideosByType($length: Int, $orderBy: VideoOrderByInput = createdAt_DESC, $attribute: [PostCat!] = [education]) {
  videos(
    first: $length
    orderBy: $orderBy
    where: {attribute_contains_some: $attribute}
...
export function useVideosByTypeQuery(options?: Omit<Urql.UseQueryArgs<VideosByTypeQueryVariables>, 'query'>) {
  return Urql.useQuery<VideosByTypeQuery, VideosByTypeQueryVariables>({ query: VideosByTypeDocument, ...options });
};