...
export default function AnxietyPage() {
	...
	return (
		<div className="flex flex-col">
			...
			<div className="px-20 bg-[#FF55CF]">
				<div className="grid grid-cols-12 gap-8">
					<div className="col-span-4">
						<img className="w-full" src="/assets/img/feed/stress.png" alt="thumbnail" />
					</div>
					<div className="col-span-6 flex flex-col justify-end py-12 gap-8">
						<h2 className="text-display-md">Grapple with Stress</h2>
						<div className="text-heading-2xs font-regular">Discover series on how to grapple with stress.</div>
