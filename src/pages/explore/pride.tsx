...
export default function PridePage() {
	...
	return (
		<div className="flex flex-col">
			...
			<div className="px-20 bg-[#EDBFFF]">
				<div className="grid grid-cols-12 gap-8">
					<div className="col-span-5">
						<img src="/assets/img/pride_header.png" alt="thumbnail" />
					</div>
					<div className="col-span-5 flex flex-col justify-end gap-8 py-12">
						<h2 className="text-display-md">Pride Month</h2>
			...
			<div className="flex flex-col gap-20 p-8 bg-gray-25">
				<VideoSection />
				<ProfileSection title="LGBTQ + Specialists" />
				<CardSection title="Pride Articles" />
				<ProfileSection title="Transgender Specialists" />
			</div>
		</div>
	)
}
