		...
		<div className="flex flex-col mt-24">
			<div className="flex flex-col py-10 px-8 gap-7">
				<div className="flex gap-7 items-center">
					<span className="text-heading-2xl">My Financials</span>
				</div>
				<div className="grid grid-cols-4 gap-14">
					<div className="p-5 rounded-2xl border-2 border-gray-50 flex gap-7">
						...
						<div className="flex flex-col gap-1">
							<span className="text-xl text-gray-400">This Month{"'"}s Income</span>
							<span className="text-heading-lg">$4,200</span>
						</div>
					</div>
					<div className="p-5 rounded-2xl border-2 border-gray-50 flex gap-7">
						<div className="p-4 rounded-full bg-gray-25">
						...
						<div className="flex flex-col gap-1">
							...
							<span className="text-heading-lg">$27,300</span>
						</div>
					</div>
					<div className="p-5 rounded-2xl border-2 border-gray-50 flex gap-7">
						<div className="p-4 rounded-full bg-gray-25">
						...
						<div className="flex flex-col gap-1">
							<span className="text-xl text-gray-400">Total Transactions</span>
							<span className="text-heading-lg">3,000</span>
						</div>
					</div>
					<div className="p-5 rounded-2xl border-2 border-gray-50 flex gap-7">
						<div className="p-4 rounded-full bg-gray-25">
						...
						<div className="flex flex-col gap-1">
							...
							<span className="text-heading-lg">08</span>
						</div>
					</div>
				</div>
